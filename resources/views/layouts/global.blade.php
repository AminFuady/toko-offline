...
<body>
    <nav class="navbar navbar-expand p-0">
        ...
        <input class="border-dark bg-primary-darkest form-control d-block w-50 ml-1 mr-1" type="text" placeholder="Search" arialabel="Search">
                ...
                <ul class="polished-sidebar-menu ml-0 pt-4 p-0 d-md-block">
                    ...
                    <div class="d-block d-md-none">
                        <div class="dropdown-divider"></div>
                            ...
                            <li><form action="{{route("logout")}}" method="POST">@csrf<button class="dropdown-item" style="cursor:pointer">Sign Out</button></form></li>
                    </div>
                </ul>
